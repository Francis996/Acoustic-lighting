...
export function OfficeMeetingRoomsPage({ content }) {
  const page = content.pages.officeMeetingRooms;
  ...
  return (
    <>
      <SiteHeader content={content} ctaHref="#office-project-support" />
      <main className="office-app-page">
          ...
          <div className="wrap office-app-hero-grid">
            <div className="office-app-hero-copy reveal">
              ...
              <div className="hero-actions">
                <a className="btn primary" href="#office-project-support" data-contact-popup>{page.hero.primaryCta}</a>
                <a className="btn glass" href="#office-cases">{page.hero.secondaryCta}</a>
              </div>
              <div className="office-app-proof" aria-label="Office acoustic lighting spaces">
        ...
        <section className="section office-app-intro">
          <div className="wrap office-app-intro-grid">
            ...
            <InlineContactCta
              eyebrow="Office Layout Review"
              title="Need acoustic lighting suggestions for desks or meeting rooms?"
              text="Send room layout, ceiling height, workstation rows or table sizes. We can recommend suitable pendant or linear models."
              cta="Review office layout"
            />
          </div>
        </section>

        <section className="section office-case-section section-soft" id="office-cases">
          <div className="wrap">
            ...
            <InlineContactCta
              eyebrow="Office Project"
              title="Planning a similar office or conference room project?"
              text="Share the target space, model references and schedule. Our team can prepare a project quotation and product options."
              cta="Discuss office project"
            />
          </div>
        </section>
        ...
        <section className="section office-spec-section">
          <div className="wrap office-spec-grid">
            ...
            <div className="spec-table reveal delay-1" role="table" aria-label="Office acoustic lighting specification notes">
        ...
        <section className="office-app-cta section-dark" id="office-project-support">
          <div className="wrap office-app-cta-grid">
            ...
            <ApplicationInquiryForm
              subject="Office & Meeting Room Acoustic Lighting Inquiry"
