...
export const blogArticles = [
  {
    title: "How to Reduce Restaurant Echo with Acoustic Pendant Lights",
    excerpt:
      "A practical guide to making restaurant conversation easier with well-distributed acoustic pendant lighting, warm layered light and realistic maintenance planning.",
    href: "/blog/reduce-restaurant-echo-acoustic-pendant-lights",
    image: "/assets/img/applications/restaurant-hospitality/harbor-view-restaurant-ko-xym-0185-corrected.png",
    label: "Hospitality Guide",
    readTime: "13 min read",
    date: "Restaurant Acoustics",
    publishedAt: "2026-09-02"
  },
  {
    title: "Acoustic Pendant Light Placement Guide: Height, Spacing and Coverage",
    excerpt:
      "Plan acoustic pendant lighting around real activity zones, with clear guidance on suspension height, photometric spacing, acoustic distribution and ceiling-service coordination.",
    href: "/blog/acoustic-pendant-light-placement-guide",
    image: "/assets/img/blog/acoustic-pendant-light-placement-hero.png",
    label: "Project Planning Guide",
    readTime: "12 min read",
    date: "Placement Guide",
    publishedAt: "2026-08-25"
  },
  {
    title: "NRC, αw and Sabins Explained for Acoustic Lighting Buyers",
    excerpt:
      "Learn which acoustic figures describe a material, which describe a complete pendant, and how to ask for meaningful fixture-level test data.",
    href: "/blog/nrc-alpha-w-sabins-acoustic-lighting",
    image: "/assets/img/blog/nrc-alpha-w-sabins-acoustic-lighting-hero.png",
  ...
  {
    title: "Acoustic Lighting vs Soundproofing: What It Can and Cannot Do",
    excerpt:
      "Learn the plain-English difference between reducing echo in a room and stopping sound between rooms, so you can specify the right solution first.",
    href: "/blog/acoustic-lighting-vs-soundproofing",
    image: "/assets/img/blog/acoustic-lighting-vs-soundproofing-hero.png",
  ...
  {
    title: "Top 15 PET Felt Acoustic Lighting Manufacturers: A Buyer’s Guide",
    excerpt:
      "Compare 15 acoustic lighting manufacturers by supplier route, design fit, technical evidence, customization and RFQ readiness.",
